...
require (
	github.com/AnomalyFi/nodekit-sdk v0.12.0
...
require (
	...
	github.com/AnomalyFi/hypersdk v0.8.0 // indirect
...
replace github.com/ethereum/go-ethereum => github.com/AnomalyFi/op-geth v0.1.0
