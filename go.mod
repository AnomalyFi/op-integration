...
require (
	github.com/AnomalyFi/seq-sdk v0.1.1 // indirect
...
//replace github.com/ethereum/go-ethereum => /home/noah/code/gethupdatenew/op-geth
replace github.com/ethereum/go-ethereum => github.com/AnomalyFi/op-geth v0.3.0
