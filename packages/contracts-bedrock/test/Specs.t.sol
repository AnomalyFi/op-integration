...
contract Specification_Test is CommonTest {
    ...
    function setUp() public override {
        ...
        _addSpec({ _name: "SystemConfig", _sel: SystemConfig.setNodeKit.selector, _auth: Role.SYSTEMCONFIGOWNER });
        //_addSpec({ _name: "SystemConfig", _sel: SystemConfig.setNodeKitL1ConfDepth.selector, _auth: Role.SYSTEMCONFIGOWNER });
